...
<div>
  <!-- <v-toolbar fixed="true">
    <v-img src="/img/icons/logo.png" aspect-ratio="1" max-width="42px" contain="false"></v-img>
  ...
  <v-content>
    <div style="height:2000px"><h1>asdasd</h1></div>
  </v-content> -->

     <v-app light>
    <v-toolbar color="white" fixed="true" height="90px">
      <v-img src="/img/logostartmikti.png" aspect-ratio="1" max-width="120px" contain="false"></v-img>
      <!-- <v-toolbar-title color="red">MIKTI - Start</v-toolbar-title> -->
      <v-spacer></v-spacer>
      <v-toolbar-items class="hidden-sm-and-down">
        <v-btn flat>Beranda</v-btn>
        <v-btn flat>Daftar</v-btn>
