...
export default {
  ...
  methods: {
    getDataList: function() {
      this.loader = true;
      net
        .getData(this, "/administrator/programmes/" + this.$route.params.programId + "/mentors")
        .then(
          res => {
            if(res.data.data){
    ...
    deleteData: function(id) {
      net
        .deleteData(this, "/administrator/programmes/" + this.$route.params.programId + "/mentors/" + id)
        .then()
        .catch(function() {})
        .finally(function() {
          this.selectedIndex = null;
