        ...
        <div class="modal-container" @click.stop>
          ...
          <v-card style="padding:0px 30px 0px 30px" class="mt-5" elevation="0" width="400">
            <v-card class="taitel primary white--text elevation-5">
              <h3 v-if="edit" class="headline mb-0 font-weight-light">{{ $vuetify.t('$vuetify.action.edit') }} Work Experience</h3>
              <h3 v-if="!edit" class="headline mb-0 font-weight-light">{{ $vuetify.t('$vuetify.action.add') }} Work Experience</h3>    
            </v-card>
