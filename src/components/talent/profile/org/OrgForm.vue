        ...
        <div class="modal-container" @click.stop>
          ...
          <v-card style="padding:0px 30px 0px 30px" class="mt-5" elevation="0" width="400">
            <v-card class="taitel primary white--text elevation-5">
              <h3 v-if="edit" class="headline mb-0 font-weight-light">{{ $vuetify.lang.t('$vuetify.action.edit') }} Organization</h3>
              <h3 v-if="!edit" class="headline mb-0 font-weight-light">{{ $vuetify.lang.t('$vuetify.action.add') }} Organization</h3>    
            </v-card>
  ...
  methods: {
    ...
    addData: function() {
      ...
      net
        ...
        .then(res => {
          this.$store.commit("incrementOrg");
          this.$emit("refresh");
        })
        .catch(error => {
          notif.showError(this, error);
