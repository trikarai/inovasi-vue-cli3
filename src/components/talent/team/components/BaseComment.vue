<template>
  <div>
    <v-container>
      ...
      <v-timeline class="pr-5" style="height:450px;overflow:auto;" dense clipped>
        ...
        <v-timeline-item v-for="comment in comments.list" :key="comment.id" color="primary" small>
          <v-card class="elevation-3 pa-3">
            ...
            <v-card color="grey" v-if="comment.parent != null"><blockquote class="blockquote caption">{{comment.parent.content}}</blockquote></v-card>
            <v-card-actions>
              <v-spacer />
